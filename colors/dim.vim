...
call s:hi('Pmenu', 'DarkGray', 'Black')
call s:hi('PmenuSbar', '', 'Black')
call s:hi('PmenuSel', 'Black', 'DarkGray')
call s:hi('PmenuThumb', '', 'DarkGray')
call s:hi('SignColumn', 'DarkGray', 'Black')
call s:hi('StatusLine', 'DarkGray', 'Black')
call s:hi('StatusLineNC', 'White', 'DarkGray')
call s:hi('TabLine', 'DarkGray', 'Black')
call s:hi('TabLineFill', 'DarkGray', 'Black')
call s:hi('TabLineSel', 'LightGray', 'Black')
