...
call s:hi('WildMenu', s:light_gray, s:dark_green)

call s:hi('LineNr', s:dark_gray)
call s:hi('Pmenu', s:dark_green, 'NONE')
call s:hi('PmenuSbar', '', s:light_gray)
call s:hi('PmenuSel', s:dark_green, 'NONE', 'reverse')
call s:hi('PmenuThumb', '', s:dark_green)
call s:hi('SignColumn', 'NONE', 'NONE')
call s:hi('StatusLine', s:dark_green, 'NONE', 'reverse')
call s:hi('StatusLineNC', s:dark_gray, 'NONE', 'reverse')
call s:hi('TabLine', 'NONE', 'NONE')
call s:hi('TabLineFill', s:dark_green, 'NONE')
call s:hi('TabLineSel', s:dark_green, 'NONE')
...
call s:hi('BufferCurrent', s:dark_green, 'NONE')
call s:hi('BufferCurrentIndex', s:dark_green, 'NONE')
call s:hi('BufferCurrentMod', s:dark_yellow, 'NONE')
call s:hi('BufferCurrentSign', s:dark_green, 'NONE')
call s:hi('BufferCurrentTarget', s:dark_green, 'NONE')

call s:hi('BufferVisible', s:dark_red, '', '')
call s:hi('BufferVisibleIndex', s:dark_red, '', '')
call s:hi('BufferVisibleMod', s:dark_yellow, '', '')
call s:hi('BufferVisibleSign', s:dark_red, '', '')
call s:hi('BufferVisibleTarget', s:dark_red, '', '')

call s:hi('BufferInactive', s:dark_gray, '', '')
call s:hi('BufferInactiveIndex', s:dark_gray, '', '')
call s:hi('BufferInactiveMod', s:dark_yellow, '', '')
call s:hi('BufferInactiveSign', s:dark_gray, '', '')
call s:hi('BufferInactiveTarget', s:dark_gray, '', '')

call s:hi('BufferTabpages', s:dark_gray, '', '')
call s:hi('BufferTabpageFill', s:dark_gray, '', '')
call s:hi('BufferOffset', s:dark_gray, '', '')

call s:hi('BufferCurrentIcon', s:dark_gray, '', '')
call s:hi('BufferVisibleIcon', s:dark_gray, '', '')
call s:hi('BufferInactiveIcon', s:dark_gray, '', '')
