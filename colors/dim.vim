...
call s:hi('WildMenu', s:light_gray, s:dark_blue)

call s:hi('LineNr', s:dark_gray)
call s:hi('Pmenu', s:light_gray, s:dark_gray)
call s:hi('PmenuSbar', '', s:light_gray)
call s:hi('PmenuSel', s:light_gray, s:dark_blue)
call s:hi('PmenuThumb', '', s:dark_blue)
call s:hi('SignColumn', 'NONE', 'NONE')
call s:hi('StatusLine', s:light_gray, s:dark_gray)
call s:hi('StatusLineNC', 'Black', s:dark_gray)
call s:hi('TabLine', 'Black', s:dark_gray)
call s:hi('TabLineFill', 'Black', s:dark_gray)
call s:hi('TabLineSel', 'Black', s:dark_blue)
...
call s:hi('CocWarningFloat', 'White', s:dark_gray)
call s:hi('CocInfoFloat', 'White', s:dark_gray)
call s:hi('CocHintFloat', 'White', s:dark_gray)
